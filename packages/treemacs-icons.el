;;; treemacs-icons.el --- custom icons for treemacs    -*- lexical-binding: t; -*-
...
;; Patched icons for treemacs to normalize width.
  ...
  (progn
    (dolist (item nerd-icons-extension-icon-alist)
      (let* ((extension (car item))
        ...
        (let* ((icon-pair (cons (format "  %s%s" icon treemacs-nerd-icons-tab)
                                (format "  %s%s" icon treemacs-nerd-icons-tab)))
